        ...
        def worker():
            try:
                text, errors = generate_validated_menu(
                    year, month, model=DEFAULT_MODEL,
                    api_key=app_config.get_api_key(), pool=mpool,
                    conditions=conds, pool_only=pool_only, paused=paused,
...
from menu_planner import DEFAULT_MODEL, generate_validated_menu  # noqa: E402
